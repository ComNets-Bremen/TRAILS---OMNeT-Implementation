...
class POI(object): 
    def __init__(self,ListSTP,px,py):
        ...
        self.stayTimes=None;    #List of times that a user spends
        self.pIndex=None;       #POI Identifier 

#Track between locations
class Link(object):
    def __init__(self,x,y,timeInterval,finalPOI,initialPOI):
